...
(deftest sabotage-test-choose-only-hq
  (do-game
...
(deftest sabotage-test-choose-only-rd
  (do-game
    (new-game {:corp {:deck [(qty "Hedge Fund" 15)]}})
    (core/resolve-ability state :runner (eid/make-eid state)
                          (s/sabotage-ability 3) (:identity (get-runner)) nil)
...
(deftest sabotage-test-choose-a-mix
  (do-game
    (new-game {:corp {:deck [(qty "Hedge Fund" 15)]}})
    (core/resolve-ability state :runner (eid/make-eid state)
                          (s/sabotage-ability 3) (:identity (get-runner)) nil)
...
(deftest sabotage-test-forced-to-trash-from-hq
  (do-game
...
(deftest sabotage-test-forced-to-trash-hq-and-rd
  (do-game
    (new-game {:corp {:deck [(qty "Hedge Fund" 7)]}})
    (core/resolve-ability state :runner (eid/make-eid state)
